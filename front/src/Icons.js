...
function NotesIcon({ size }) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 256" id="Flat" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
function ProjectsIcon({ size }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <path stroke="currentColor" d="M6 7C6 6.44771 6.44772 6 7 6H10C10.5523 6 11 6.44772 11 7V17C11 17.5523 10.5523 18 10 18H7C6.44772 18 6 17.5523 6 17V7Z" fill="black" />
      <path stroke="currentColor" d="M13 7C13 6.44772 13.4477 6 14 6H17C17.5523 6 18 6.44772 18 7V13C18 13.5523 17.5523 14 17 14H14C13.4477 14 13 13.5523 13 13V7Z" fill="black" />
    </svg>
  );
}
