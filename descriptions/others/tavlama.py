...
def app(alt_sinir, ust_sinir, d, delta, T, Tend, sk):
    ...
    while Tend < T:
        degisim_miktari = get_DegisimMiktari(
            -(ust_sinir - alt_sinir)*delta/2, (ust_sinir - alt_sinir)*delta/2, d)
        cozum = get_Cozum(d)
...
cozum, obj, iterasyon, array_obj, array_iterasyon = app(
    -5, 5, 6, 0.1, 1000, 0.1, 0.9)
